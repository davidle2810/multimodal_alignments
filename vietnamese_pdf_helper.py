...
pytesseract.pytesseract.tesseract_cmd = r"C:/Users/Quoc Anh/AppData/Local/Programs/Tesseract-OCR/tesseract.exe"
...
def enhance_image(image):
    ...
    threshold_image = cv2.adaptiveThreshold(enhanced_image, cv2.ADAPTIVE_THRESH_GAUSSIAN_C, cv2.THRESH_BINARY_INV)
...
def clean_text_with_gemini(input_text):
    ...
    prompt = [
        ...
        "random symbols like '®?)', 'Ø⁄', 'CðuÁnft', etc., while keeping the structure intact:\n\n",
        f"{input_text}\n\n"]}
    ]
