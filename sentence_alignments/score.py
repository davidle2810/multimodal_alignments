...
def log_final_scores(res):
    ...
    print('| Precision   |   {precision_lax:.3f} |'.format(**res), file=sys.stderr)
    print('| Recall      |   {recall_lax:.3f} |'.format(**res), file=sys.stderr)
    print('| F1          |   {f1_lax:.3f} |'.format(**res), file=sys.stderr)
    print(' -------------------------', file=sys.stderr)
